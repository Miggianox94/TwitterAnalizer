...
ALTER TABLE TWEET ADD CONSTRAINT TWEET UNIQUE (WORD,SENTIMENT_FK);

ALTER TABLE HASHTAG ADD CONSTRAINT HASHTAG UNIQUE (WORD,SENTIMENT_FK);

ALTER TABLE EMOJI ADD CONSTRAINT EMOJI UNIQUE (WORD,SENTIMENT_FK);

ALTER TABLE EMOTICON ADD CONSTRAINT EMOTICON UNIQUE (WORD,SENTIMENT_FK);
